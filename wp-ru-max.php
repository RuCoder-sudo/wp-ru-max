 ...
 * -----------------------------------------------------------------------
 * Плагин позволяет:
 * – Отправлять записи, страницы и любые CPT в канал MAX (авто или вручную)
 * – Пересылать все email (включая заказы WooCommerce, формы) в личный чат с ботом MAX
 * – Добавлять на сайт плавающий чат-виджет с анимацией привлечения внимания и звуком
 * – Вести полный лог событий с JSON‑запросами
 * – Работать через лицензионный ключ (бессрочная лицензия)
 * -----------------------------------------------------------------------
 ...
 * – Документация (Wiki):  https://github.com/RuCoder-sudo/wp-ru-max/wiki
 * – Сообщить об ошибке:   https://github.com/RuCoder-sudo/wp-ru-max/issues
 * – Купить лицензию:      https://kwork.ru/user/RuCoder (кворк «WP Ru-max»)
 * -----------------------------------------------------------------------
 */
...
define( 'WP_RU_MAX_VERSION', '1.0.21' );
