...
if ( ! defined( 'WP_RU_MAX_VERSION' ) ) define( 'WP_RU_MAX_VERSION', '1.0.63' );
...
// Version 1.0.63: the bundled module uses the same cache-busting version as
// the main plugin. The duplicate contacts renderer was removed so the
// «Связь с клиентами» screen is rendered only once.
if ( ! defined( 'WP_RU_MAX_PRO_VERSION' ) ) define( 'WP_RU_MAX_PRO_VERSION', '1.0.63' );
