 ...
 *
 * Multisite / Поддомены:
 * - Сетевая лицензия хранится в get_site_option('wp_ru_max_network_license')
 * - is_active() сначала проверяет сетевую лицензию, затем лицензию сайта
 * - Лицензия на корневой домен (example.com) автоматически покрывает поддомены (sub.example.com)
 */
