    ...
    public function save() {
        ...
        $settings = array(
            ...
            'style' => array(
                ...
                // Версия 1.0.51: новые компоновки доступны и в сохранённых
                // настройках, и в preview.
                'layout' => in_array( $style_raw['layout'] ?? '', array( 'circle', 'list', 'grid', 'corner', 'menu', 'stack', 'fan', 'rows', 'arc' ), true ) ? $style_raw['layout'] : 'circle',
