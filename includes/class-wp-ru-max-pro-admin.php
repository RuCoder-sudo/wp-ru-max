...
class WP_Ru_Max_Pro_Admin {
    ...
    public function assets( $hook ) {
        ...
        wp_enqueue_style( 'wp-ru-max-pro-admin', WP_RU_MAX_PRO_URL . 'admin.css', array(), WP_RU_MAX_PRO_VERSION );
        wp_enqueue_style( 'wp-ru-max-pro-preview', WP_RU_MAX_PRO_URL . 'preview.css', array( 'wp-ru-max-pro-admin' ), WP_RU_MAX_PRO_VERSION );
        wp_enqueue_script( 'wp-ru-max-pro-admin', WP_RU_MAX_PRO_URL . 'admin.js', array( 'jquery' ), WP_RU_MAX_PRO_VERSION, true );
