...
### 1.0.22
- **Инструкция:** внизу вкладки «Инструкция», после «Полезные ссылки», добавлен блок **«Согласие пользователя»** — текст подтверждает, что пользователь ознакомлен с правовыми документами и даёт согласие на обработку email, имени, фамилии и домена для обработки заявки и отправки лицензионного ключа активации
